...
namespace okta_aspnetcore_mvc_example.Controllers
{
    public class HomeController : Controller
    {
        ...
        public void GetProfile()
        {
            ...
            if (oktaUser.Profile["customId"] != null) { _userProfileModel.customId = oktaUser.Profile["customId"].ToString(); }
        ...
        [HttpPost]
        //[Authorize]
        public IActionResult ProfileRoute([FromForm] UserProfileModel updateUser)
        {
